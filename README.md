Inventory Management System is a semi-automatic system that manages inventory for a College in a University. The inventory objects are of different types.
